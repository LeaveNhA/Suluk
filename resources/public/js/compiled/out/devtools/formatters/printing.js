...
var len__43354__auto___51700 = arguments.length;
var i__43355__auto___51701 = (0);
while(true){
if((i__43355__auto___51701 < len__43354__auto___51700)){
args__43361__auto__.push((arguments[i__43355__auto___51701]));

var G__51702 = (i__43355__auto___51701 + (1));
i__43355__auto___51701 = G__51702;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__43362__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq51697){
var G__51698 = cljs.core.first.call(null,seq51697);
var seq51697__$1 = cljs.core.next.call(null,seq51697);
var G__51699 = cljs.core.first.call(null,seq51697__$1);
var seq51697__$2 = cljs.core.next.call(null,seq51697__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__51698,G__51699,seq51697__$2);
});
...
if(cljs.core.truth_((function (){var or__42183__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__42808__auto__,writer__42809__auto__,opt__42810__auto__){
return cljs.core._write.call(null,writer__42809__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__42171__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__42171__auto__){
var or__42183__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__51703_SHARP_){
return !((cljs.core.meta.call(null,p1__51703_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__51704__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__42183__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e51708){var _e__50691__auto__ = e51708;
return false;
}})();
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
...
}catch (e51710){var _e__50691__auto__ = e51710;
return false;
}}
})())){
...
var _STAR_current_state_STAR_51712 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__51713 = opts;
...
var markup_db = cljs.core.get.call(null,map__51713__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_51712;
}});
...
;
var temp__4655__auto___51717 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___51717)){
var managed_print_level_51718 = temp__4655__auto___51717;
var _STAR_print_level_STAR_51716_51719 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_51718;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_51716_51719,managed_print_level_51718,temp__4655__auto___51717,writer,opts,job_fn){
return (function (p1__51715_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__51715_SHARP_,null);
});})(_STAR_print_level_STAR_51716_51719,managed_print_level_51718,temp__4655__auto___51717,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_51716_51719;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1510612167415
