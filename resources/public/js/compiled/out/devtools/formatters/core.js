...
var and__42171__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__42171__auto__){
var or__42183__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e53257){var _e__50691__auto__ = e53257;
return false;
...
}catch (e53259){var _e__50691__auto__ = e53259;
return false;
...
}catch (e53261){var _e__50691__auto__ = e53261;
return false;
...
}catch (e53263){var _e__50691__auto__ = e53263;
return false;
...
}catch (e53265){var _e__50691__auto__ = e53265;
return false;
}})())){
...
}catch (e53267){var _e__50691__auto__ = e53267;
return false;
}})())){
...
var _STAR_current_state_STAR_53269 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__42183__auto__ = config;
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53269;
}});
});
...
return (function() { 
var G__53271__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e53270){var e = e53270;
devtools.reporter.report_internal_error_BANG_.call(null,e,"an exception was raised during value formatting");

return null;
}};
var G__53271 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__53272__i = 0, G__53272__a = new Array(arguments.length -  0);
while (G__53272__i < G__53272__a.length) {G__53272__a[G__53272__i] = arguments[G__53272__i + 0]; ++G__53272__i;}
  args = new cljs.core.IndexedSeq(G__53272__a,0,null);
} 
return G__53271__delegate.call(this,args);};
G__53271.cljs$lang$maxFixedArity = 0;
G__53271.cljs$lang$applyTo = (function (arglist__53273){
var args = cljs.core.seq(arglist__53273);
return G__53271__delegate(args);
});
G__53271.cljs$core$IFn$_invoke$arity$variadic = G__53271__delegate;
return G__53271;
})()
;
});
...
var pre_handler = (function (){var or__42183__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
var post_handler = (function (){var or__42183__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1510612169179
