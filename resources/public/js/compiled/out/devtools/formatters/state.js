...
var len__43354__auto___51691 = arguments.length;
var i__43355__auto___51692 = (0);
while(true){
if((i__43355__auto___51692 < len__43354__auto___51691)){
args__43361__auto__.push((arguments[i__43355__auto___51692]));

var G__51693 = (i__43355__auto___51692 + (1));
i__43355__auto___51692 = G__51693;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43362__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq51689){
var G__51690 = cljs.core.first.call(null,seq51689);
var seq51689__$1 = cljs.core.next.call(null,seq51689);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__51690,seq51689__$1);
});
...
return (p1__51694_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1510612167367
