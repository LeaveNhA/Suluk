...
var o51569 = temp__4655__auto__;
var temp__4655__auto____$1 = (o51569["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o51570 = temp__4655__auto____$1;
return (o51570["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__50684__auto__ = f;
return (o__50684__auto__["toString"]).call(o__50684__auto__);
} else {
return "";
}
}catch (e51571){var _ = e51571;
return "";
}});
...
try{var o__50684__auto___51573 = t;
(o__50684__auto___51573["cljs$lang$ctorPrWriter"]).call(o__50684__auto___51573,t,writer);
}catch (e51572){var __51574 = e51572;
}
...
var char_code = (function (){var o__50684__auto__ = (new String(char$));
return (o__50684__auto__["charCodeAt"]).call(o__50684__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__50684__auto__ = String;
return (o__50684__auto__["fromCharCode"]).call(o__50684__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51575 = num_code;
switch (G__51575) {
case (1):
return (185);
...
var o__50684__auto__ = String;
return (o__50684__auto__["fromCharCode"]).call(o__50684__auto__,superscript_code);
});
/**
...
}catch (e51577){var _e__50691__auto__ = e51577;
return false;
}})())){
...
var vec__51578 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__51578,(0),null);
...
var or__42183__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o51581 = temp__4655__auto__;
var temp__4655__auto____$1 = (o51581["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o51582 = temp__4655__auto____$1;
return (o51582["nameToPath"]);
} else {
return null;
}
} else {
...
var len__43354__auto___51589 = arguments.length;
var i__43355__auto___51590 = (0);
while(true){
if((i__43355__auto___51590 < len__43354__auto___51589)){
args__43361__auto__.push((arguments[i__43355__auto___51590]));

var G__51591 = (i__43355__auto___51590 + (1));
i__43355__auto___51590 = G__51591;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43362__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51585){
var vec__51586 = p__51585;
var ns_detector = cljs.core.nth.call(null,vec__51586,(0),null);
var effective_detector = (function (){var or__42183__auto__ = ns_detector;
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
var G__51592 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__51593 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__51592;
remaining_tokens = G__51593;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51583){
var G__51584 = cljs.core.first.call(null,seq51583);
var seq51583__$1 = cljs.core.next.call(null,seq51583);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__51584,seq51583__$1);
});
...
var vec__51597 = cljs.core.split_with.call(null,(function (p1__51596_SHARP_){
return cljs.core.not_EQ_.call(null,p1__51596_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__51597,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__51597,(1),null);
...
var vec__51600 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__51600,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__51600,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__51603 = cljs.core.rest.call(null,remaining_tokens);
var G__51604 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__51603;
name_tokens = G__51604;
continue;
} else {
...
var vec__51607 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__51607,(0),null);
var arity = cljs.core.nth.call(null,vec__51607,(1),null);
var vec__51610 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__51610,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__51610,(1),null);
var vec__51613 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__51613,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__51613,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__51613,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__51613,(3),null);
...
var vec__51619 = result;
var munged_ns = cljs.core.nth.call(null,vec__51619,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__51619,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__51619,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__51619,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__51619,(4),null);
var arity = cljs.core.nth.call(null,vec__51619,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__51623 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__51623,(0),null);
var args = cljs.core.nth.call(null,vec__51623,(1),null);
var vec__51626 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__51626,(0),null);
var name = cljs.core.nth.call(null,vec__51626,(1),null);
...
var G__51629 = (arity + (1));
var G__51630 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__51631){
var vec__51632 = p__51631;
var arity = cljs.core.nth.call(null,vec__51632,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__51632,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__42183__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__51635_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__51636_SHARP_){
return cljs.core.drop.call(null,(2),p1__51636_SHARP_);
...
var args__43361__auto__ = [];
var len__43354__auto___51643 = arguments.length;
var i__43355__auto___51644 = (0);
while(true){
if((i__43355__auto___51644 < len__43354__auto___51643)){
args__43361__auto__.push((arguments[i__43355__auto___51644]));

var G__51645 = (i__43355__auto___51644 + (1));
i__43355__auto___51644 = G__51645;
continue;
} else {
}
break;
...
var argseq__43362__auto__ = ((((1) < args__43361__auto__.length))?(new cljs.core.IndexedSeq(args__43361__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__43362__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__51639){
var vec__51640 = p__51639;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__51640,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq51637){
var G__51638 = cljs.core.first.call(null,seq51637);
var seq51637__$1 = cljs.core.next.call(null,seq51637);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__51638,seq51637__$1);
});
...
var G__51646 = arg;
var G__51646__$1 = (((G__51646 instanceof cljs.core.Keyword))?G__51646.fqn:null);
switch (G__51646__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__42183__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__42171__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__42183__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
...
var map__51648 = options;
var map__51648__$1 = ((((!((map__51648 == null)))?((((map__51648.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51648.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51648):map__51648);
var include_ns_QMARK_ = cljs.core.get.call(null,map__51648__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__51648__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__51648__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__51648__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__51649 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__51649,(0),null);
var fn_name = cljs.core.nth.call(null,vec__51649,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__51649,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__51649,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__51649,(4),null);
var arity = cljs.core.nth.call(null,vec__51649,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__42171__auto__ = protocol_ns;
if(cljs.core.truth_(and__42171__auto__)){
return cljs.core.not.call(null,(function (){var and__42171__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__42183__auto__ = protocol_part;
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
return fn_part;
...
var o__50684__auto__ = f;
return (o__50684__auto__["getBasis"]).call(o__50684__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__42171__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__42171__auto__)){
...
}catch (e51653){var _e__50691__auto__ = e51653;
...
var G__51654 = (obj[cljs.core.first.call(null,path)]);
var G__51655 = cljs.core.rest.call(null,path);
obj = G__51654;
path = G__51655;
continue;
} else {
...
var partition_bits = (function (){var or__42183__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__42183__auto__)){
return or__42183__auto__;
} else {
return (0);
...
return (function (accum,p__51656){
var vec__51657 = p__51656;
var bit = cljs.core.nth.call(null,vec__51657,(0),null);
var protocol = cljs.core.nth.call(null,vec__51657,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__51660){
var vec__51661 = p__51660;
var ns = cljs.core.nth.call(null,vec__51661,(0),null);
var name = cljs.core.nth.call(null,vec__51661,(1),null);
var selector = cljs.core.nth.call(null,vec__51661,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__51666,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__51666,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__51666,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__51664_SHARP_){
return (obj[cljs.core.first.call(null,p1__51664_SHARP_)]);
});})(name,sorted_matches,vec__51666,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1510612167259
