...
var or__42183__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj48338 = {"detail":data};
return obj48338;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__42171__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__42171__auto__)){
var and__42171__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__48345 = cljs.core._EQ_;
var expr__48346 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__48345.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__48346))){
return ((function (pred__48345,expr__48346){
return (function (p1__48339_SHARP_){
return console.warn(p1__48339_SHARP_);
});
;})(pred__48345,expr__48346))
} else {
if(cljs.core.truth_(pred__48345.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__48346))){
return ((function (pred__48345,expr__48346){
return (function (p1__48340_SHARP_){
return console.debug(p1__48340_SHARP_);
});
;})(pred__48345,expr__48346))
} else {
if(cljs.core.truth_(pred__48345.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__48346))){
return ((function (pred__48345,expr__48346){
return (function (p1__48341_SHARP_){
return console.error(p1__48341_SHARP_);
});
;})(pred__48345,expr__48346))
} else {
return ((function (pred__48345,expr__48346){
return (function (p1__48342_SHARP_){
return console.log(p1__48342_SHARP_);
});
;})(pred__48345,expr__48346))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__48349){
var map__48350 = p__48349;
var map__48350__$1 = ((((!((map__48350 == null)))?((((map__48350.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48350.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48350):map__48350);
var opts = map__48350__$1;
var eval_fn = cljs.core.get.call(null,map__48350__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__48352_SHARP_);
});})(new_def))
);
...
return (function (p__48353){
var vec__48354 = p__48353;
var ky = cljs.core.nth.call(null,vec__48354,(0),null);
var v = cljs.core.nth.call(null,vec__48354,(1),null);
...
if(cljs.core.truth_((function (){var and__42171__auto__ = typeof localStorage !== 'undefined';
...
}catch (e48359){if((e48359 instanceof Error)){
var e = e48359;
return not_found;
} else {
throw e48359;
...
//# sourceMappingURL=utils.js.map?rel=1510612164866
